...
app.use('/uploads/products', express.static(productUploadDirectory, { dotfiles: 'deny', index: false }));
app.use('/uploads/profiles', express.static(profileUploadDirectory, { dotfiles: 'deny', index: false }));
